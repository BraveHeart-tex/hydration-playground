        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between mb-4">
            ...
            <div className="flex gap-4">
              ...
              <button className="bg-emerald-600 text-white px-4 py-2 rounded-lg hover:bg-emerald-700">Post Ad</button>
            </div>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button className="bg-emerald-600 text-white px-8 py-3 rounded-lg hover:bg-emerald-700">Search</button>
          </div>
        </div>
      </header>
      ...
      <section className="bg-gray-50 py-6">
        <div className="max-w-6xl mx-auto px-6">
          <div className="flex gap-4 overflow-x-auto">
            {["🚗 Vehicles", "💻 Electronics", "🛋️ Furniture", "🏠 Real Estate", "💼 Jobs", "🔧 Services"].map(
              (category, index) => (
                <button
                  key={index}
...
async function UrgentListingsSection() {
  ...
  const urgentListings = [
    ...
    { title: "2020 Honda Accord - Quick Sale", price: "$22,000", location: "Oakland, CA", urgent: "Price Drop" },
    { title: "iPhone 15 Pro - Unopened", price: "$950", location: "San Jose, CA", urgent: "First Come" },
  ]
    ...
    <section className="py-12 bg-red-50 border-l-4 border-red-500">
      <div className="max-w-6xl mx-auto px-6">
        <div className="flex items-center gap-2 mb-8">
          ...
          <span className="bg-red-100 text-red-700 px-3 py-1 rounded-full text-sm font-medium">Time Sensitive</span>
        </div>
          ...
          {urgentListings.map((listing, index) => (
            ...
            >
              <div className="flex justify-between items-start mb-2">
                ...
                <span className="bg-red-500 text-white px-2 py-1 rounded text-xs font-bold">{listing.urgent}</span>
              </div>
...
async function CategoriesSection() {
  ...
  const categories = [
    { title: "Vehicles", description: "Cars, motorcycles, boats", count: "2,341 listings" },
    { title: "Electronics", description: "Phones, laptops, gaming", count: "1,892 listings" },
    { title: "Furniture", description: "Home & office furniture", count: "956 listings" },
    { title: "Real Estate", description: "Apartments, houses, land", count: "743 listings" },
    { title: "Jobs", description: "Full-time, part-time, gigs", count: "1,234 listings" },
    { title: "Services", description: "Cleaning, repair, tutoring", count: "567 listings" },
  ]
...
async function FeaturedListingsSection() {
  ...
  const listings = [
    { title: "2019 Honda Civic", price: "$18,500", location: "San Francisco, CA", image: "🚗" },
    { title: 'MacBook Pro 16"', price: "$2,200", location: "New York, NY", image: "💻" },
    { title: "Vintage Leather Sofa", price: "$850", location: "Austin, TX", image: "🛋️" },
    { title: "iPhone 14 Pro", price: "$899", location: "Los Angeles, CA", image: "📱" },
    { title: "Mountain Bike", price: "$650", location: "Denver, CO", image: "🚴" },
    { title: "Gaming Setup", price: "$1,200", location: "Seattle, WA", image: "🎮" },
  ]
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {listings.map((listing, index) => (
            ...
            >
              <div className="h-48 bg-gray-100 flex items-center justify-center text-6xl">{listing.image}</div>
              <div className="p-4">
          ...
          {sales.map((sale, index) => (
            <div key={index} className="flex justify-between items-center p-4 border rounded-lg">
              ...
              <div className="text-right">
                <p className="text-xl font-bold text-emerald-600">{sale.soldFor}</p>
  ...
  return (
    <section className="py-12 bg-red-50 border-l-4 border-red-500">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[1, 2, 3].map((i) => (
            <div key={i} className="bg-white rounded-lg shadow-sm border-2 border-red-200 p-4">
              <div className="flex justify-between items-start mb-2">
